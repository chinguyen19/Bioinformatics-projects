...
### <1> The volcan plot representing of the proportion of upregulated and downregulated genes based on their gene expression values:<br>
<p align="center">
...
### <2> The heatmap of the top 50 genes from differential expression analysis:<br>
<p align="center">
